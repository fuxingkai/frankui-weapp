...
Page({
  ...
  // opts.radian = 2*Math.PI / 360*167;
    updateData['instrumentData.canvasWidth'] = systemInfo.screenWidth;
    updateData['instrumentData.canvasHeight'] = 205;
    updateData['instrumentData.width'] = systemInfo.screenWidth;//整个画布宽度
    updateData['instrumentData.height'] = 205;//整个画布高度
