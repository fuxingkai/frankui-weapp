...
Charts.prototype.updateData = function(opts) {
    ...
    this.config.xAxis.data = opts.xAxis.data ? opts.xAxis.data : this.config.xAxis.data;
    this.config.yAxis.data = opts.yAxis.data ? opts.yAxis.data : this.config.yAxis.data;
    this.config.series = opts.series ? opts.series : this.config.series;
    this.opts.series = opts.series ? opts.series : this.opts.series;
    this.scrollOption = {
        currentOffset: 0,
        startTouchX: 0,
        distance: 0
